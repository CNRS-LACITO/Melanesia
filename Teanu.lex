...
\rm
\xm Udo na abia tamwase tae.
\xb There aren't that much of this banana…
\lf Cf.
\lv engaenga
\ln various
\lf Ant.
...
\rm
\xm lava abilo
\xb the sides of a snake (name of a liana)
\se lava abilo
\ps n
\gr
\ll sides of a snake
\dn name of a large liana whose shape is reminiscent of a large snake
\lf Cf.
\lv lava
\se abilo peini revo
\ps n
...
\rf
\un Synt.
\en Often in serialisation.
\lf Ant.
\lv vene
\sn 1
\wn physical motion
\dn go down, fl:esp. from inland towards the sea
\rf
\xv I-sabu i-abu ne ero.
\xn He fell down in the river.
\rf
\xv Kuo ponu i-atili i-abu i-le.
\xn The canoe slid all the way down (to the sea).
\rm
\xm li-elele kuo iada i-abu
\xb
\lf
\sn 2
\hn fig
...
\gn Food:3du
\rn their
\dn their: form of the possessive classifier used for food, tools,
customary possessions etc. (fv:enaka*), with a 3 dual possessor
(fl:see fv:da)
\rf
\xv mama ada
...
\gn Kin:2pl
\rn their
\dn their: form of the possessive classifier used for kin terms (fv:one*),
with a 3 dual possessor (fl:see fv:da)
\rf
\xv et' ada
...
\rn their
\dn their: form of the possessive classifier used for kin terms (fv:one*),
with a 3 plural possessor (fl:see fv:dapa)
\rf
\xv et' adapa
\xn their mother
\rf
...
\xn dark, rainy cloud
\rm
\xm Li-romo adawo boroboro ponu.
\lf Cf.
\lv ioti
\ln rain cloud
\el
...
\xn Why did they go? [ax:lit. they went for what thing?]
\un
\en Often contracted as |fv{nganae}*.
\sn 2
\wn between pauses
\hn
\uv
\dn hesitation marker used when looking for one's words, fl:espec.
before a noun
\rf
...
\lf
\ta §TIT§ |{tab}|fb{Parts of the leg}  [|vl{aele}*]
|{tab}|fv{aele}   |{tab}|{tab}|fs{lower limb, leg}
|{tab}|fv{waluko aele}   |{tab}|{tab}|fs{thigh}
|{tab}|fv{visibaele}   |{tab}|{tab}|fs{knee}
|{tab}|fv{waburo ne aele}   |{tab}|{tab}|fs{kneecap}
|{tab}|fv{belemele ne aele}    |{tab}|fs{ankle}
|{tab}|fv{bava aele}   |{tab}|fs{foot}
|{tab}|fv{uta aele}   |{tab}|{tab}|fs{heel}
|{tab}|fv{vidiko ne aele}   |{tab}|{tab}|fs{toe}
\se ~la aele
\ps voi
\ll take legs
...
\xn Shall we go to the reef and look for some shells?
\sd Sea
\sn 2
\hn esp
\dn bivalve shell, traditionally used as an instrument to grate (|fv{~lu})
coconut flesh or scrape the skin of tubers
\lf
\el POc
\et *kaRi
\nt
...
\dn small cowrie shell used as traditional money in some areas of
Melanesia, though not in Vanikoro
...
\sn 2
\hn esp
\dn the sun in its course, insofar as it is taken as reference to assess the
time of the day
\sd
\rf
\xv Aeve ka i-tavali. ~ Aeve ka i-le.
\xn [The sun has gone down] it is late afternoon.
\sn 3
\hn hence
\dn hours on the clock
\rf
...
\gn 2s:R
\rn you
\dn you: variant of fv:a- (2sg Realis prefix) before a vowel or certain
monosyllabic roots
\rf
\xv Ai-ovei Cindy?
...
\hn
\uv
\dn classificatory father: any male member of the parental generation (F,
FB, FZH…) except the maternal uncle (MB = fv:gea)
\lf
\se
\ps intj
\wr B
\gr
\ll father!
\dn affectionate address term, used by an elderly person, to a young
man who has children — including to his own son. Sometimes a
...
\gn Food:3Gen
\rn *
\dn form of the possessive classifier used for food, tools, customary
possessions etc. (fv:enaka*), with an impersonal possessor (fv:idi
‘people’)
\rf
\xv Na tanoe aidi abia.
\xn This land belongs to everyone.
...
\xn In the olden days, black sorcery would make use of someone's leftover food,
or of their leftover betel nut.
\lf
\el
\nt
\dc 10/May/2012
...
\gn Kin:3Gen
\rn *
\dn form of the possessive classifier used for kin terms (fv:one*), with an
impersonal possessor (fv:idi ‘people’)
\rf
\xv Et' aidi li-odo uko ñe basa damiliko iadapa.
\xn The mums are searching for lice in their children's hair.
\lf
\el
\nt
\dc 10/May/2012
...
\gn Food:2pl
\rn your
\dn your: form of the possessive classifier used for food, tools,
customary possessions etc. (fv:enaka*), with a 2 plural possessor
(fl:see fv:kaipa*)
\rf
\xv Pi-valangia nganae aipa ponu?
\xn What are you guys carrying?
\rf
...
\gn Kin:2pl
\rn your
\dn your: form of the possessive classifier used for kin terms (fv:one*),
with a 2 plural possessor (fl:see fv:kaipa*)
\rf
\xv Pie aipa li-atevo i-ka?
\xn Did you hear them from your grandparents?
\lf
\el
\nt
\dc 12/May/2012
...
\rm
\xm Lai-aiu momobo, io, pon ne pwa moe iada.
\sn 2
\wn
...
\xn As soon as the northern wind began to blow, they left [Vanikoro] and set off
to sail southwards.
\nq up (and do s.th.). A lively way to introduce a new action in a narrative, whether
an upward movement is present or not. fl:Hence used as a clause linker:
suddenly, then, without further ado
\rf
\xv
\nt c'est surtout vrai au nord Vanuatu !! mais ici pas sûr
\lf
\el
\nt
\nq
...
\xb Mi kolektem rabish from eria blg haos blg mi.
\rf
...
\xn Today it's blowing very hard. (viz. the wind)
\lf Cf.
\lv ~vi
\ln blow gently
\sn 2
...
\un
\en The phrase |vl{awa ini i-aka} ‘he's angry’ has given rise to a verb |vl{~wañaka}*
‘be angry’.
\lf
\el
\nt
...
\gn Food:1in.pl
\rn our
\dn our: form of the possessive classifier used for food, tools, customary
possessions etc. (fv:enaka*), with a 1st inclusive plural possessor
(fv:kiapa)
\dn
\rf
...
\gn Kin:1in.pl
\rn our
\dn our: form of the possessive classifier used for kin terms (fv:one*),
with a 1st inclusive plural possessor (fv:kiapa)
\dn
\rf
...
\sn 2
\uv plant
\dn become yellowish as a result of growing
\rf
\lf
\nt cf. which word again?
\sn 3
\ge mûr
\gn ripe
\hn esp
...
\gn (island)
\rn *
\dn name of a small island close to Utupua (fv:Tetevo)
\rf Hell-Door.21
\xv
\nq or is it in fact the name of Utupua??!
\el
\nt
\dc 10/May/2012
\dt 12/May/2012
...
\rn
\hn rare
\dn diminutive: small, in small quantity; few
\rf
\xv none aidi mijaka
...
\rf
\rm
\xm Piene peini mijaka nga pon.
\xb His story is quite short.
\un
\lf Cf.
\lv apilaka
\ln little
...
\sn 2
\wn
\dn crushed seaweed, traditionally used as a protective varnish and
insect repellent on wood
\rf DG1-46b
...
\sd
\rf
\xv Nga ne bogo, le-romo i-katau vangana kanmoro iu, li-ovei li-ejau anoko
iadapa.
\on sailing ships
\xn At night, they would follow the shining stars, and thus recognise their
itinerary.
\lf
\el
\nt
...
\lx anuele
\ph anuele
\pc .G.c:\Alex\photoDico\totel.jpg;1.36";0.83";JPG
\ps n
\gr totel
\ge tortue
\gn turtle
...
\gr
\ll baby turtle
\dn a bird's name: Ruddy Turnstone
...
\dn amber
\rf
\nq did I write this down somewhere?   or just in my memory??
\nt loro ie añawo = amber ?!!  from my memory
\el
\nt
\nq
\dc 28/Nov/2009
...
\xn Many thanks for the email you sent to me.
\lf
\el
\nt
\nq
...
\rf
\xv emele aplaka
\xn [ax:lt. a small woman] a young girl
\rf
...
\gr
\ll frigate wings
\dn name of a traditional geometrical design (|fv{tetawene}), whose
shape is reminiscent of open wings
\sn 2
\uv fish
\gn fins
\dn side fins
...
\ge suspendu
\gn hang
\dn be hanging in the air
\rf
\xv Uña asodo dapa li-avo ne bonge.
\xn Bats hang in caves.
\rm
\xm Uña udo pe i-ako, li-lui i-avo ne tone.
\xb The ripe bananas had been put to hang from the hook.
\se ~la i-avo
\ps vt
\gr
...
\xn The cupboard is located above the fire.
\sn 3
\uv head
...
\un
\en Formal synonym of fv:jebute.
\lf
\el
\nt
\nq
...
\hn
\uv
\dn the seat of feelings, the ‘heart’. Grammatical subject of certain
predicates referring to feelings
\rf
\xv Awa* ene i-su.
\xn [my throat is blocked] I am sorry.
\rf
\xv Awa* ene i-aka.
\xn [my throat blows] I am angry.
\rf
...
\dn the seat of will and desire. The combination of fv:awa with
|fv{~viaene}* ‘hit’, and/or with |fv{~ko} ‘say’, results in the
meaning ‘want, like’
\rf
\xv Awa ene i-viaene tamwase!
\xn [my neck/mind hits it!] I absolutely love it!
\rf
\xv Awa kupa i-viane pi-ko u-le u-romo tadoe akapa.
\xn [our neck/mind hits says you go and see…] We'd like you to go and meet our
god.
\rf
\rm
\xm Awa dapa le-ko le-lebie ne revo.
\xb They want to swim in the sea.
\sn 4
\hn hence
\dn will, desire
\rm DG1-06
\xm Awa ini abia.
\xb He's got lots of desires.
\rf
...
\xn A woman went to draw saltwater, and brought it back to pour it above the
oven.
\un
\en A pit is dug in the ground of the kitchen, filled with cooking stones (fv:visiboko).
Once the fire (fv:iawo) has heated these stones, the food (fv:none) is placed on
them so as to be cooked (fv:~apinu) or baked (fv:~vai).
\lf
\el
\nt
\dc 10/May/2012
...
\ge chaux
\gn lime
\dn lime, used when chewing areca nut (|fv{buioe}), in combination
with betel leaves (|fv{puluko})
\rf DP2-03a
\lf Cf.
\lv ~kanu
\el
...
\rf
\xv Kape li-au ñe uie baudo.
\xn We will wrap (the food) with XXX leaves.
\nq maybe < /ba udo/ = banana leaves??
\lf
\el
\nt
\nq
...
\gn ash
\dn ashes
\so http://language.psy.auckland.ac.nz/austronesian/language.php?id=355
\rf
\lf
\nt only found on ABVD, together with /viomoro/
\el
\nt
\dc 21/Feb/2010
\dt 12/May/2012
...
\ge
\gn
\dn discourse particle, of unclear meaning
\sd
\rf Kava.08
...
\ge
\gn antenna
\dn long antennae found on certain ritual headdresses (fv:tamate),
representing the Spirit's eyes
\rf Tamate.162
\xv Noma, mata pon, be mata pon! Tilu.
\on mythical times
\xn In the olden days, eyes were on two antennae.
\lf Cf.
\lv mata
\ln eye
\el
...
\sn 2
\hn euph
\dn a funeral ceremony taking place in the house of a recently dead
person
\rf DG1-33b
\xv
\un Anth
\en Relatives gather in the house and sit for a whole night…
\lf
\el
\nt
\nq
...
|vl{Li-la voro pe bele ini jiejie, li-kai bele utedie ini, awoiu li-la li-teli ne aeve me kokoro. Awoiu li-dai ñe vilo li-asai botongo. Awoiu ka i-wene peini u-totoñe via kome, via wele, tekumete, nga pon.}
|fs{‘If you catch one of those stingrays whose skin is rough and rugged, you tear the skin off its back, and put it to dry in the sun. Then, you wrap it around a stick, and tie it with a stitch. It can be used for sanding axe handles, paddles, wooden dishes, and so on.’}
\el
\nt
\nq
\dc 24/Nov/2009
...
\gr
\ge
\de *grille* de bambou tressé sur laquelle on pose de la nourriture pour la préserver
ou la cuire
\gn shelf
\dn ‘almond shelf’: a shelf made of woven bamboo, hanging high over
the fireplace in the kitchen, used for storing canarium almonds
(fv:vongoro) while they dry
\rf DP1-2b
\rf
\xv Li-bi vongoro li-kamai, li-loko i-vene ne belemele li-sabisi li-maliawo boso.
\xn They picked almonds and brought them home, poured them all up on the
almond shelf; then they lit a fire underneath.
\rf
\xv Mwalik' iape i-ven' i-la vongoro ne belemele i-abu i-vo.
\xn Her husband climbed to take some almonds down from the shelf, and began
crushing them.
\lf
\el
\nt
...
\xv bete peini uie luro
\xn mat made of coconut leaves
\rf
\xv li-vei bete
\xn weave a mat
\xv li-bu bete
...
\gr
\ll put away mats
\dn hold a funeral ceremony at the house of a dead person
\lf Cf.
\lv ~lu
\se
\ps nop
...
\ge
\gn
\dn Striped bristle tooth, a fish
\sd Fish
\sc Clenochaelus striatus
\so BTlex!
\rf
\lf
\el
...
\xn banyan roots
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (90).jpg
\el POc
\et *ᵐbaᵑga
\nq check POc
\nt
...
\sd Bot
\rf DG2-12a
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (96).jpg
\nq je retrouve que c'est Premna corymbosa, mais c'est déjà pris !!!
\lf Cf.
\lv tevalvalo
\el
\nt
...
\rf
\xv buia loubaido
\xn [testicles of c.c.] **greasy appendix** of a coconut crab
\se buia luro
\ps n
\gr
\gn germinated_coconut
\dn germinated coconut; sprout ball formed inside such a coconut
\lf
\el
\nt
\dc
...
\sn 2
\hn esp
\dn areca nut, as commonly chewed (|fv{~kanu})
\rf
\xv li-ali buioe
...
\un Synt.
\en Takes the Food possessive classifier (vl:enaka).
\el POc
\et *buaq
\nt
\nq
...
\et *bunaR
\eg
\ec etymo in Pawley 2004 (handout);  also Osmond p.57
\nt
\nq
\dc 24/Mar/2008
\dt 12/May/2012
...
\gr
\ll song of bamboos
\dn song genre, meant to accompany on the sound of pounded
bamboos
\sd Mus
\rf
\lf Cf.
...
\un
\en More commonly referred to as |vl{jebute}*.
\lf
\el
\nt
\nq
...
\gn 3:du
\rn *
\dn third dual independent pronoun
\rf
\lf
\el
\nt
...
\dn exceed, surpass ‹s.th., s.o.› in doing s.th., fl:hence do s.th. better fl:or
be more than. Forms comparative structures
\rf
...
\xv datilu meliko
\un
\en Suppletive plural of vl:menu or vl:apali.
\lf Cf.
\lv menu
\el
\nt
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (77).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\xn Our elders know what the real (language) should be.
\rf
\xv Ini i-te Franis, ia ebele kulumoe iape Japan.
\xn She lives in France, but she is actually from [ax:lit. her genuine country is]
Japan.
\sn 4
\wn exclamatory
\dn beautiful
...
\sd Kin
\un
\en Originally an address term.
\lf Syn.
\lv pie
\sn 1
\dn grandparent; anybody from the grandparent generation, whether
male or female (FF, FM, MF, MM, MMZ, MMB…)
\rf
\xv epu iape
\xn his/her grandfather
\sn 2
\dn grandchild; anybody from the grandchild generation, whether male
or female (SC, DC+)
\lf
\el
\nt
...
\xn your mother
\sn 2
\dn classificatory mother: any female member of the preceding
generation (M, MZ, MBW, FZ, FBW)
\rf
\en The symmetrical term is vl:menu (fl:Pl. vl:dameliko) or vl:apali.
\lf
\el
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (76).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\sn 3
\wn ego male
\dn nephew, niece (MBDC): child of o.'s female cross-cousin fv:leka
\lf
\el
\nt
\nq
...
\ge crier
\gn shout
\dn call out with high-pitched voice, fl:typic. in order to reach out to a
distant or invisible person in the bush
\rf DP2-14b
...
\gn 3s
\rn *
\dn Realis 3rd singular mood prefix
\sn 2
\dn Irrealis 3rd singular mood prefix
\rf
\lf
\el
\nt
...
\gn of
\wn foll. by NP
\dn default possessive classifier for alienable possession
\rf
\xv
\xm moe ie teliki
\lf Cf.
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (80).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\xn The pig tusk has come out and spun around.
\nq any traditional value??
\se ije b(w)oe
\ps n
\gr
...
\hn
\nq apparemment mes notes ont inversé les deux photos?
\et
\nt
\nq
\dc 28/Nov/2009
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (69).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\sn 2
\wn by analogy
\dn Diodon or Porcupine fish, a toxic fish
\sc Diodon holacanthus
\sd Fish
\lf
\el
\nt
...
\xn Taros can't grow here, due to lack of water.
\un Etym.
\en Contraction of |vl{die} ~ |vl{jie} ‘sucker’ and |vl{bute}* ‘taro’.
\lf Syn.
\lv avtebe
\el
\nt
...
\sn 6
\wn
\dn bamboo organ: a large panpipe-shaped instrument made of
...
\un
\en An instrument recently introduced from islands further west (fl:esp. Malaita). The
sound is produced by striking (|fv{~abu}) the mouth of each tube with a beater
...
\rf DP2-19a
\xv A-ka a-kae? – Ni-katau anoko ni-ka.
\xn How did you come? – I just followed the road.
\rf
...
\xn We have brought here this small box, with the idea to leave it with you.
\un Synt.
\en Often the object is expressed in preceding clause, and not repeated after
|fv{kamai}.
\lf Ant.
\lv ~lui
\ln take away
...
\rf DG2-21a
\rf DG2-02b
\nt esp. Honeycomb grouper !! =  Epinephelus merra
\lf
\se kanikawo teiene
\ps n
\gr
...
\xn We drink tea, we chew areca nuts, and we play cards.
\un
\tn |{tab}|fb{Chewing areca nuts} (|vl{~kanu})
Vanikoro is, with Tikopia, the world's easternmost place where the chewing of areca nuts is a traditional practice. People go in the forest to pick (|vl{~ali}) areca nuts (vl:buioe), and pinch (|vl{~kidi}) betel leaves (|vl{puluko}). The two elements are then mixed with lime (vl:awo), and chewed together (|vl{~kanu}) until feeling dizzy (fl:see |vl{~avo}).
\lf
\el Tik.
\et kamu
\nt
...
\xn Genuine canoes have an outrigger.
\un
\en Although this verb is criticised as a loanword, it is frequently heard in informal
speech. The equivalent in the vernacular would involve an existential predicate,
usually with |vl{~wene}.
\lf
\el Pjn
\et garem
\el Eng
...
\rf
\nq =Mtp /nasam/
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (86).jpg
\el ax:See
\et ule
\nt
\nq
...
[ax:lit. following islands].
\rf
\xv I-e idi, i-e idi, i-katau kulumoe ra ra ra ra ra ra – kulumoe moli.
\xn (the Ogre) ate people, dozens of people, going from one village to another
[ax:lit. following villages], on and on and on, until all the villages were empty.
\rm
\xm Kape i-moloe moli i-katau temaka iakapa na.
\xb He will do nothing but wander around everywhere in our country [ax:lit. wander ‘following our
places’].
\rf
\xv La-tabe mata ka la-lui la-do i-katau ngogoro.
\xn They collected tree shoots, and began to plant them everywhere in the forest
[ax:lit. following the forest].
\sn 6
\hn fig
\uv
...
\on calendar
\xn In the old days, people would just refer themselves to [ax:lit. follow] the
moon.
\se mata i-katau
\ps phr
\gr
...
\sn 2
\wn
\dn a narcotic drink made after this plant, and consumed by men on
important occasions
\rf
\xv Dapenuo li-le ne toplau, li-anu kava. Li-anu kava awoiu, ka li-vongo viri.
\xn Men would go in the men's clubhouse, and drink kava. Once they had drunk
kava, they would eat.
\rf
\xv Daviñevi wopine li-ovei pe li-anu kava.
\xn Old women are allowed to drink kava.
\rf
\xv Tano ponu, li-ae mijaka me kava i-pu i-katau.
\xn This kava bowl (|vl{tano}*) has been hollowed out a little, to allow kava to
flow along.
\un
\en The consumption of kava is claimed to be customary on Vanikoro. However, the
fact that this is a Polynesian loanword suggests this practise was introduced in
relatively times. Still today it is only drunk on rare occasions; the traditional daily
drug of Vanikoro is really the areca nut (vl:buioe).
\lf
\ta §TIT§ |fb{Words of kava}   [|vl{kava}*]
|{tab}|fv{kava}|{tab}|{tab}|{tab}kava
|{tab}|fv{teipu}|{tab}|{tab}|{tab}coconut shell
|{tab}|fv{tano}|{tab}|{tab}|{tab}kava bowl
\el Polynesian
\et kava
\nt
\nq
...
\dn go from inland towards the sea; go downhill; (at sea) move away
from the island, towards the ocean
\lf Cf.
\lv teta-ke
\ln seawards
\sn 3
...
\hn fig
\uv
\dn come out, come to light, appear
\rf
\xv Ije pwoi i-ke i-dadai.
\xn The pig tusk has come out and spun around.
\el
...
\lf Cf.
\lv vede
\nt corresponds to /nōyōpdēge/ in Mwotlap!!  not to /nēgēy/ or /na-gavag/
\se kie tebene
\ps n
\gr
...
they buried the boards in them.
\lf Cf.
\lv moboe
\ln hole
\sn 2
...
\xv Abu ne-kila Puma!
\on teleradio
\xn I'll try and get (the people of) Puma.
\un
...
\xn This place is called “Devils' Lair”.
\lf
\el
\nt
\nq
...
\xn [ax:lit. when two people follow each other] when there is a wedding
\rf DP2-13a
\xv Nga u-romo leka, kape u-kila.
\xn Should you have any eye contact with your cross-cousin, you will have to
marry her.
\se ~kila emele
\ps voi
\ll join a woman
...
\xv kiñe otovo
\xn long and thin leaves on the eaves of a sago thatch
\xv kiñe udo
...
\va kiñe viabasa
\gr
\dn hair, considered in its length rather than its volume
\rf AF-Q-44
\xv kiñe viabasa
\xn one hair
...
\ps n
\uv
\dn the long, many fibres made of leaves, which hang down from a
fv:tamate ritual mask, by way of the Spirit's hair
\rf
\el
\nt
\nq
...
\sn 3
\wn deictic use
\dn exclamatory particle pointing to the immediate context, fl:typic. to
the addressee's speech or action
\rf DP2-19a
\xv A-tomoli ko!
\xn That's just a liar!
\rf
\xv Na bwara eo ko!
...
\dn …
\sn 3
\wn often foll. by vl:bwara
\dn think
\sn 4
\wn foll. by Irrealis clause
\dn want to
\rf
\sn 5
\wn serialised after a verb of speech or thought
\dn that: equivalent of a complementiser
\ue
\ee
\lf
\el
...
moko taniboro.
\xn Some people pull the two ends of the scareline towards the shore, to a dry
zone.
\sn 4
\wn id.
...
\xn (The islanders) welcomed them inland. They lit torchlights and led them in,
until they reached (the village) inland.
\lf Cf.
\lv ~wokobe
\el
\nt
...
\rf
\rm
\xm Iaero tilu ponu da la-kopine engasune.
\xb these 2 rivers...
\un Etym.
\en From |fv{~ko pine} ‘wide open’
\lf
\nt < i-ko pine
\el
\nt
...
\rf
\un Etym.
\en Perhaps from |vl{kula} ‘several’ + |vl{moe} ‘house’.
\lf Cf.
\lv temaka
\ln place
\sn 1
...
\xn [take a fishhook & bring it] Please bring a fish-hook!
\rf
\xv Li-la ruene li-tabo li-bono.
\xn [they ‘take’ the door and shut it] They shut the door again.
\rf
\xv U-la teili u-bi ñ' eo.
\xn [take a fan and fan yourself] Fan yourself with a fan!
\rm
\xm Li-la viko li-lateli.
\xb They took the money and put it down.
\rf DG4-04b
\xv Ai' iape kape i-la men' iape i-koioi ne Toplau.
\xn The father would introduce his son into the Men's House [ax:lit. would ‘take’
his son and introduce him].
\rm
\xm Namolo i' emel' iono po va nga i-te ne manoko, kape i-la i-kawi ñe dapa.
\nt /kawi/ = couvrir
\se ~la ~lui
\ps vt
\gr
...
\xn Last night [an earthquake ‘took’ & shook this house] this house was shaken
by an earthquake.
\sn 4
\wn
\dn give <s.th.>
...
\xn Some softwares are free [ax:lit. people take/give them unconstrained].
\rf
\xv Taluaito i-la ero ie menu apilaka.
\xn The doctor gave medicine to the little child [ax:lit. he took/gave the child's
water].
\un
...
\xn Making a canoe can take up to 3 or 4 days.
\sn 8
\uv
\dn do, make. Combines with certain objects, to form semantically
...
\un Etym.
\en Prob. from |vl{~la} ‘take’ + vl:biouro ‘long’.
\se labiou tae
\ps phr
\gr
\ll it was not long
...
\rf
\xv Aeve ka i-vene labiou awoiu.
\xn The sun had long risen in the sky.
\el
\nt
\nq
\dc 23/Nov/2009
...
\xn In the olden days, killing someone could be done using a variety of objects,
such as, their clothes, their hair, the food they left, the nut they chewed…
\un
\en
\lf Cf.
\lv taluaito
...
\ps n
\ll snake sides
\dn k.o. liana (unidentified), ‘Great bean vine’
\sc
\sd Bot
\rf DG1-18b
\rf DG2-11b
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (115).jpg
\lf Syn.
\lv kasule lava abilo
\lf
\el
\nt
\nq
...
\gn
\ll handle of axe
\dn k.o. seashore tree, whose hard wood is used to carve artifacts, e.g.
for axe handles
\sc Scaevola taccada
\sd Bot
\rf DG2-12a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (83).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\rm
\xm Ni-le ne eo tae.
\xb [I don't go to you] I don't believe you.
\rf DP2-11b
\xv Dapa li-le ne ene tae.
\xn [They didn't go to me] They didn't believe me.
\rf
\xv Ene ni-lengi ñe taña ene, ka ebele piene, ene ni-le ene.
\xn I heard it with my own ears. It's the truth, I believe it.
\un Synt.
\en This construction consists of the verb |vl{~le} ‘go’ + the locative preposition vl:ne
or locative adverb vl:ene.
\el (?) POc
\et *lako
\nt
\nq
...
\ll go one
\dn (do) in the same way, (do) the same
\rf DP1-05
\xv Damala li-kila i-le iune.
\xn Westerners call it the same.
\sn 2
\ge ensemble
\gn together
\dn (do) together
...
\ge affamé
\gn hungry
\wn Subject = vl:mata ‘eyes’
\dn be hungry
\rf
\xv Mata ene i-ledi.
\xn [my eyes are hungry] I am hungry!
\lf
\el
\nt
\nq
...
\gn cousin
\wn symmetrical term
\dn cousin, cross-cousin, whether male or female (MBC, FZC)
\rf
\xv leka emele
\xn female cousin
...
\xn With your (opp.-sex) cross-cousin, you are not allowed any body contact.
\un Anth
\en Any sort of contact between cross-cousins of opposite sex, whether eye- or
body-contact, is strictly prohibited. If it ever occurs, then the two individuals must
marry. As a consequence, cross-cousins – who can be potentially spouses – avoid
each other strictly.
\lf
\el
\nt
...
\rf
\rm DP1-18a
\xm U-eke daviñevi i-lemoli etapu!
\sn 3
\wn as predicate
\dn not matter
\rf
...
\rf DG2-11a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (64).jpg
\nq identif°??  cf. Mtp /napyoh/
\el
\nt
\nq
\dc 20/Feb/2010
...
\sn 3
\hn gen
\dn introduces a plural object, animate or not, before a verb of motion
or displacement
\rf
...
\rm
\xm I-loko dapa i-lui ne kulumoe iadapa.
\xb
\lf
\el
\nt
...
\rf DG2-12a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (93).jpg
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (94).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\dn vomit, puke
\rf
\xv Basavono po mwaliko malaria i-vagasi, basa i-meli, mwaliko i-loro, panavono
i-ke.
...
\lx loubo
\ph louᵐbo
\pc .G.c:\Alex\photoDico\krab.jpg;1.6";1.12";JPG
\ps n
\gr krab
\ge crabe
\gn crab
...
\rf DG4-05a
\xv Basavono po li-bu, kape le-tomoe mina Lovia Vono na, le-le ne Lovia Vono
iote.
\xn When we die, we leave this World, and migrate to the Other World.
\un
\en The word fv:marama, borrowed from Mota, is sometimes used with the same
meaning.
\el
\nt
\nq
...
\ge Lovono
\gn Lovono
\dn Vono* fl:or Lovono: a village on the north coast of Banie, together
with its area
\rf
\xv piene adapa Lovono
\xn the language of Lovono
\ee This village is also known, in the literature, under the names Vanou or Whanou
(Dillon). Its local name, in the language Lovono, is vl:Vana.
\lf
\el
\nt
\nq
...
\nt noté /i-lu/ = MTP /hip ni-tintin (mi ni-vingey)/
\nq translation??
\lf
\el
\nt
...
\rf
\lf
\tn |{tab}|fb{Folding away the deadman's mats} £ |{tab}[|vl{~lu bete}*]
|vl{Idi le-bei bete awoiu, kape le-lu bete. Bete ka mwoe pon, ie mwaliko pe i-bu. Li-aneve lema mwoe, ka maro. Awoiu, le-loko ajekele le-iui ne revo.}
|fs{‘At the end of the funeral vigil (|vl{~bei bete}*), comes the time when we fold the mats away. These are the mats, and the house, of the person who died. So we clean the house, both inside and outside. We collect the garbage (including the mats) and we go throw them in the sea.’}
\el
\nt
\nq
\dc
...
\ta §TIT§ |{tab}|{tab}|fb{Words for carrying} [|vl{~lui}*] 
|{tab}|fv{~lui} |{tab}|{tab}|fs{take away} 
|{tab}|fv{~kamai} |{tab}|{tab}|fs{bring} 
|{tab}|fv{~koioi} |{tab}|{tab}|fs{take in} 
|{tab}|fv{~kevei} |{tab}|{tab}|fs{take out} 
|{tab}|fv{~vesu} |{tab}|{tab}|fs{take up, erect} 
...
\rf Lap:Usao.01
\xv Vana uña toñaki i-ka i-loko dapa ne kulumoe na, dapa li-lui li-langatene ne
Iura.
\xn Ships used to come to this island to collect people, and then take them away to
make them work somewhere in the south.
\rf cf. Tamate.016
\xv Ngiro i-aka i-lui dapa.
\xn The wind blew and took them away.
\rm Lap-Rub.Lvn.02
\xm Dapa Franis ka dapa li-ka li-loko idi li-lui li-ko le-la ngatene le-mini dapa.
\xb The French came here to collect people and take them away, with the intention to make them work for
them.
\lf
\el
\nt
...
\hn
\uv s.th.
\dn sound, fl:esp. singing sound of an instrument (fl:vs. |fv{aña}
‘noise’)
\rf
...
\hn esp
\uv man
\dn marriage proposal sent (|fv{~teli}*) to the family of a woman
\rf DP1-55%
\xv U-teli mama ene se.
\on formula for official engagement
...
\ge pudding
\gn pudding
\dn k.o. traditional pudding, made of taros (|fv{jebute}) and Canarium
almonds (|fv{vongoro}), and served in important social occasions
\rf
\xv Li-wete jebute li-wete vongoro awoiu pon, li-ejau mama.
\xn We mash taros, we crush almonds, and make the pudding.
\rf
\xv li-wete* mama
\xn prepare the pudding
\un
\en One cooks taros first, and then mash them, together with almonds, in a mortar
(|vl{monone}), until it becomes a tender dough.
\lf
\el
\nt
\nq
...
\rf DG2-16a
\un Anth
\en Vanikoro people used to trade the red feathers of this little bird with other islands
of the Santa Cruz archipelago. They were then transformed into customary
money.
\so
\nt BTA = this bird provided red feathers which were traded to Santa Cruz to make the
feather money used traditionally on Santa Cruz as dscribed by Bill Davenport in
...
\dn look, direction of the eyes as they look
\rf
...
\xn First of all, we plant the offshoot (of taro).
\lf Cf.
\lv jie
\ln sucker
\sn 2
...
\xv vebe mata-diro
\on analogy of shape
\xn [ax:lit. arrow-tip vl:vebe] a kind of Barringtonia fruit
\el
\nt
\nq
\dc 17/Nov/2009
...
\rm Lap-BenTua.066
\xm Ponu dapa ka li-vete piene peini li-votei mata piene nao.
\lf Cf.
\lv maluo
\ln life
\el
...
\en Used for medicinal purposes (fv:tongolukilo).
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (32).jpg
\nq Mwotlap /nētētē/ =>> identification???
\se matamulue vao
\ps n
\gr
...
\rf
\nt
\nq Mwotlap /nētētē mayaqo/ =>> identification???
\nq PROBLEM of identification!!!
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (60).jpg
\el
\nt
\nq
\dc 20/Feb/2010
...
\ps vti
\wr B
\dn lure (s.o./s.th., |fv{ñe}) with a bait
\rf
...
\dn ‘famine food’: plant which is not ordinarily used as a staple, yet
which is known to be edible enough to be consumed in case of crop
shortage or disaster
\sn 2
\hn meton
\dn a shrub (Verbenaceae) whose food was traditionally consumed in
case of famine
\sc Vitex trifolia
\sd Bot
\rf DG2-11a
...
\rf
\xv Basa ene i-meli.
\xn I have a headache.
\xv Die ini i-meli.
\xn [Her back hurts.] She's having labour contractions.
\rf
\xv Nara sa i-meli!
\xn Make sure you don't get tummy ache ~ don't end up heartbroken!
\lf
\el
\nt
\nq
...
\xn Kava drinkers eat cutnut right after it, to take away the bitter taste. [ax:lit.
for fear their teeth might taste-bitter]
\lf
\el
\nt
\nq
...
\xn Do you want it? – No, I don't (want it).
\sn 2
\hn
\uv
...
\gn shy
\ll shy of oneself
\dn be shy, timid; shy away (from, |fv{ne})
\rf DP1-23a
...
\gn talk
\uv human
\dn talk, utter words, considered as a general faculty (fl:vs |fv{~vete
piene} ‘say s.th.’)
\rf
\xv I-mui pe i-mo.
\on disabled child
\xn He cannot speak.
\nt sur Womtelo, John ici le 22/03/2008
\rf DP2-
\xv Ka i-mo tae!
\on accident+
...
\gr toko strong
\ll talk strong
\dn speak with a firm tone of voice, fl:esp. in giving a lesson or firm
advice; fl:hence reprimand (s.o., fv:se)
\rf
...
\ll Devils' lair
\hn
\dn place (fl:typic. cave) haunted by spirits or deities; fl:hence heathen
temple
\rf
\xv Ka ponu li-la viko, li-lui li-lateli ne moe ma tadoe.
\xn They took the shell-money, and put it down in the gods' lair.
\ue Ethn
\ee Ancestral priests are represented as visiting this place to worship their gods and
send imprecations.
\el
\nt
\nq
...
\xn Kava is not something you drink randomly [ax:lt. just any day].
\lf
\sn 3
\uv s.o.
...
\ps vi
\gr
\ll lie unconstrained
\dn be easy
\mn ~wene moli
\sn 2
\dn without expected effects: fl:hence (do) in vain, for nothing; with no
satisfying result
\rf DG1-06a
\xv Li-vo moe moli.
...
\rf DP2-09b
\xv Program kula idi li-la moli.
\xn Some softwares are free [ax:lit. people give them unconstrained].
\rf DG1-06a
\xv Ini i-langatene moli.
\xn He works for free.
\sn 4
\uv eat, drink+
\dn without expected ingredients: fl:hence minimally, simply, in a sober
fl:or pure fashion
\rf
\xv Ni-anu moli.
\on water
...
\sn 5
\dn with no binding rules or ties: fl:hence randomly, aimlessly,
haphazardly
\rf
\se ~le moli
\ps vi
...
i-ejau mama ada.
\xn Once the taro was cooked, she put it in a mortar and began to pound it. When
she finished pounding it, she made the pudding.
\sn 2
\dn a sturdy box, fl:typic. made of wood, where to stow things; chest,
trunk
\sd Mod
\rf
\xv Kupa pi-kamai monone apilaka ne pe-ko me pe-kamai i-wene tev' eo.
...
\ge
\hn fig
\dn compound element found in several (now opaque) words referring
to old age and maturity: |fv{amoso}, |fv{momoso}, |fv{makumoso}.
\rf
\lf
\el POc
\et *matuqa
...
\hn
\uv speech
\dn formal, carefully worded; sounding nice, idiomatic
\rf DP1-28a
\xv Dapa wopine na li-vete piene ne “ebele ini!” tamwase, pe li-ko motoro. Ia
piene “wako” pon, mimione.
\xn The elders very often use this expression “it's wonderful”: they find it a nice
[ax:lit. heavy] word. Whereas a word like “alright” is a bit too common. [it's
light]
\lf
\el
\nt
...
\xn I didn't know, you should have told me!
\rf
\xv Ene ni-mui ni-ko kape n-ajau nganae kape wako.
\xn I don't know what to do.
\rf
\rm
\xm Temaka pe li-ke na, ni-mui.
\xb As for where they went, I have no idea.
\un
\en
\rf DP2-20b
\lf Ant.
\lv ~ovei
\sn 2
\dn be unable (to do, |fv{pe}+Clause)
\rf
\xv I-mui pe i-mo.
\xn He cannot speak.
\sn 3
...
\dn sibling-in-law, whether male or female: spouse of o.'s sibling (ZH,
BW), fl:or sibling of o.'s spouse (WB, WZ, HB, HZ)
\rf
\xv mul' one mwalkote
...
\ln sibling
\sn 2
\dn spouse of o.'s cross-cousin, cousin by marriage (MBDH, MBSW;
FZDH, FZSW; HFZC, WFZC…)
\rf
\lf Cf.
\lv leka
...
dances (instruments, jumping boards+)
\el
\nt
\nq
\dc 19/Nov/2009
...
\xv noma nuduro
\xn the (front) ends of the fishing-scareline
\sn 3
\hn
\uv time period
\dn end of <s.th.>
...
\un
\en Most cape names begin with the syllable vl:Nom', from vl:noma.
\se
\ps adv
\wr C
\gr bifo
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (75).jpg
\el POc
\et *mapuqan
\nt
\nq
...
\lv uo
\ln Greater yam
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (40).jpg
\el
\nt
\dc 20/Feb/2010
\dt 20/Feb/2010
...
\rf
\sn 1
\dn long rope made of rattan stems (|fv{woworo}) tied together, used as
a scareline for fishing; “fishing rope”, “scareline”
\rf DP2-16a
\xv Li-ngago woworo awoiu ka li-kila li-ko nuduro.
\xn We tie together rattan stems, and call it a vl:nuduro (scareline).
\rf
\un
\en Contrary to what is observed in other parts of the Pacific, this scareline does not
include coconut palms or leaves.
\se ~lui nuduro
\ps voi
\gr
\ll carry the scareline
\dn a fishing technique whereby a group of men surround the reef at
low tide, holding a long ‘scareline’ (fv:nuduro), and catch the fish
kept prisoner within the line
\sd Techn
\rf DP2-15b++
\xv Mobo kape le-lui nuduro me l-abu namuko.
\xn Tomorrow we'll carry the scareline to get some fish.
\tn |{tab}|fb{Scareline fishing} £ |{tab}[|vl{~lui nuduro}*] 
|vl{Basavono pe li-ejau nuduro, li-le li-toe woworo, awoiu li-ngago. Li-ngago awoiu ka li-kila li-ko nuduro. Dapa kula li-katei noma nuduro tilu ponu, li-koioi tetakoie, i-le i-vene ne moko taniboro; dapa kula li-vio ne revo li-dai adie nuduro li-abu revo, me le-labu namuko.} 
|fs{‘When we prepare the scareline, we go cut rattan stems and tie them together. Once they're tied together it becomes a ‘scareline’ (vl:nuduro). Some people pull the two ends of the line towards the shore, to a dry zone; others stand in the water, on the other side of the scareline, and hit the water to (scare and) catch the fish.’}
\sn 2
\dn palm of coconut or palmtree, displayed in some specific location to
mark it as private or taboo; fl:hence taboo, ban, prohibition to enter
a place
\rf
\xv li-vi nuduro
\xn set a taboo leaf
...
\xn My uncle put up a taboo in his garden / in his house / on the reef… (using a
coconut palm).
\rf DP2-15b+
\xv Dapa li-woi nuduro ne touro, me i-botongo temaka.
\xn They put up taboo signs on the seashore, to protect the area (from poachers).
...
\rf DP2-12a/b
\xv i-sube ñe nuduro
\xn [make a mistake on a taboo] infringe a moral taboo; do wrong, intentionally
or not
\rf
\xv i-bei nuduro
...
\ll in the back of
\wn spatial
\dn beyond, on the other side of ‹a place›
\sd
\rf
\xv n' adie kulumoe
...
\dn afterwards, then
\rf Funeral.02
\xv Nga mwaliko i-bu, dapa le-le le-iu ebele ini. N' adie, dapa abia ne kulumoe
kape le-bei bete.
\xn When somebody dies, people bury their body. fn:Afterwards, everyone in the
village will hold a funeral ceremony.
\un Synt.
...
\rf
\un
\en According to the myth, Ñivale, together with its neighbouring islet Sebei, were
separated from the mainland of Banie by the legendary hero Mwasu.
\lf
\el
\nt I hear "Ñivale" in the tape, and this is also the form used by Ezzy in his emails. However
a bunch of kids were correcting the form to "Ñilale" with /l/.
\dc 17/May/2012
\dt 18/May/2012
...
\xn You people are human; but we are just non-human creatures [ax:lit. just
things] like this.
\rf
...
\rf
\xv Ngatene pon etapu tamwase.
\xn This is a taboo issue.
\rf DP2-15a
\xv Vesepiene iune, i-vete ngatene tilu.
\on polysemy
\xn It is the same word, but with two distinct meanings. [ax:lit. it says two
things]
\lf Cf.
\lv awa
\sn 6
...
\un
\en The combination of the verb |vl{~la} ‘take’ and vl:ngatene ‘things’ results in the
meaning ‘to work’.
\lf Cf.
\lv ~langatene
\el
...
\rf
\xv Li-panade okoro awoiu li-si tele-mwoe peini mwoe.
\xn We split the bamboos, to make the wallings of a house.
\rf
\lf Syn.
\lv jokoro
\sn 3
\wn
\uv
\dn a heavy bamboo, used as a stamping tube. Singers of |fv{buro bula
okoro} ‘bamboo songs’ stamp (|fv{~woi}) the bamboo on the
ground, thereby producing a deep sound as they sing along
\sd Mus
\rf
\xv buro bula okoro
\on song genre
...
\wn
\hn esp
\dn a traditional knife made of bamboo; |fl{hence} (modern) knife;
bushknife, machete
\rf DP1-17
\xv Ni-aka okoro ne ero.
\xn I washed the knife in the river.
...
\xn Let's walk to the shore and find some (sea) food.
\lf
\el
\nt
\nq
...
\gr
\ll
\dn variety of sago tree, characterised by a smaller trunk and smooth
leaf sheaths
\sc Metroxylon warburgii
\sd Bot
\rf DG2-11a
\rf
\nt = Mtp /noyot men/
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (43).jpg
\se otovo kotekote
\ps n
\gr
\ll spiny sago
\dn variety of sago tree, characterised by a larger trunk and spiny leaf
sheaths
...
\xn Spiny sago trees have large trunks.
\nt = Mtp /noyot diy/
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (44).jpg
\sn 2
\wn
\hn meton
...
\xn Our roofing has been damaged, we are making [ax:lt. pinning] a new one.
\rf
...
\gr
\ll Heron's tracks
\dn written signs fl:or letters; letter, message
\rf
\mn angede ovene
\el
\nt
...
\xn When somebody has malaria, they have a headache, they tremble, they sweat.
[ax:lit. sweat comes out]
\lf
\el
\nt
\nq
...
\ge
\gn
\dn k.o. tree with unedible, small round fruit clustered together;
probably:
\sc Ficus aspera
\sd Bot
\rf DG2-11a
\lf
\nq precise identification??  cf. Mtp /nowoh/
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (36).jpg
\el
\nt
\nq
\dc 20/Feb/2010
...
\un Hist.
\en Term used especially when referring to the time of Blackbirding, involving the
forceful recruiting of manpower from Vanikoro and other islands.
\lf
\se
\ps vi
\wr B
\gr
\wn esp. serialised to a verb V1
\uv
...
\sn 1
\gn sea
\dn sea, fl:esp. marine zone surrounding the island and accessible on a
daily basis (fl:vs. fv:ngamuli ‘ocean’)
\sd
\rf
\xv abilo peini revo
\xn seasnake
...
\ph roe teᵐbene
\ps n
\ll vl:roe turned yellow
\dn k.o. tree, unidentified
\sc
\sd Bot
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (70).jpg
\nq = Mtp /nuquqay/ !
\el
\nt
\nq
...
\el
\nt
\nq BTA gives another Sp for this name!!  and also another name for this Sp!! 
(samwaele) ==> je corrige d'après BTA + étymologie
\dc 28/Nov/2009
\dt 09/May/2010
...
\lv sakoro
\el
\nq I had noted /sakoro/ => perhaps wrong.
\nq BTA gives another Sp for this name!!  and also another name for this Sp!! 
(samwaele) ==> je corrige d'après BTA + étymologie
\dc 28/Nov/2009
\dt 12/May/2012
...
\gn blocked
\uv opening
\dn obstructed, clogged up, blocked by s.th.
\rf
...
\rf
\xv Awa ene i-su.
\xn [my neck is blocked] I am sorry.
\el
\nt
\nq
\dc 17/Nov/2009
...
\sn 2
\dn make a faux pas; do wrong, by accident rather than deliberately;
infringe (s.th., |fv{ñe})
\rf
\xv A-sube ñe nuduro.
...
\on myth of origin
\xn When our country emerged, our Ancestral God was called Banie.
\lf
\el
\nt
\nq
...
\xn Some men went to cut firewood in the forest and brought it back home (on
their shoulders).
\rm
\xm Ni-tabe mana luro.
\xb I'm carrying some rice (on my shoulder).
\nt also "bless" = bénir = *tendre* la main sur qqn
\rm Email Stanley
\xm ai' akapa itabe ma-ini boso eo ka unia damiliko iono tie.
\xb God bless you and your children, my friend.
\xm
\lf Cf.
\lv ~valangia
\ln carry on stick
...
\rf
\xv I-tabo!
\on when transcribing
\xn [let it repeat!] Play it again!
\sn 2
\hn comm
\wn auxiliary-like; foll. by verb V2, with same subject
\uv
...
\rf
\xv Otovo iupa ka tamwaliko, pi-tabo pi-wete kula motoe.
\xn Our roofing has been damaged, we're making a new one again.
\se
\ps ptc
\wr B
\gr
...
\un Morph.
\en The particle occurs at the same place as the auxiliary-like verb form |vl{~tabo},
except that it does not take verbal prefixes.
\el
\nt
\nq
\dc 20/Nov/2009
...
\rf DG1-36a
\lf
\nq quelle identification boudiou?
\nt emprunt polynésien??
\el
\nt
\dc 20/Feb/2010
\dt 20/Feb/2010
...
\rm
\xm Kape le-te le-kae?
\xb How could they have remained there?
\sn 4
\wn
\dn wait
\rf
...
\uv s.o.
\dn be: be in such and such a condition, whether temporarily or
permanently
\rf
\xv A-te moli?
\xn Are you free?
...
\ge
\gn
\dn k.o. round basket, coarsely woven with coconut leaves, and used to
carry food
\sd Artf
\rf DG2-19a
\lf
...
\gn pale
\uv plant
\dn of a pale fl:or yellowed colour
\rf
\xv kie* tebene
...
\hn
\uv
\dn the Fan: name of a constellation, whose stars seem to delineate a
diamond-shaped fan with its handle
\rf DP1-26b
\lf
\el Polynesian
\nt
...
\rf DG2-12a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (79).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\se ~la ~teli
\ps svt
\nt serial verb, transitive
\ll take & put
\dn put ‹s.th.› down
\en The combination |fv{~la ~teli} is often contracted as |fv{~lateli}*.
\sn 2
\dn plant ‹fruit, taro+›
\rf
\xv li-teli balawe
...
\uv man
\dn require official engagement (to a woman, |fv{ñe}/|fv{se}) from her
family
\rf DP1-31b
...
\sn 2
\hn hence
\dn conch shell, traditionally used as a trumpet, fl:esp. when sending
out public signals fl:or calling out to people
\rf
\xv Ni-si teveliko.
...
\rf DG4-06a
\un Morph.
\en From |vl{tev(ie) viri} ‘rear side’.
\lf Ant.
\lv basa
\lv teviumu
\ln prow
...
\sd Kin
\gr brata
\dn sibling: irregular form of |fv{tilio}* for 3sg (‘his/her sibling’) and
when followed by a noun (‘sibling of X’)
\rf
\xv Tilio, we tieli?
\xn Is he your brother, or her brother?
\rf
\xv Gea ini tieli ete mwalkote.
\xn Your uncle is your mother's brother [ax:lit. her male sibling]
\rf
\xv Da tieli.
...
\xn They suddenly saw a tornado break through the clouds – it was [long and thin] like a
coconut tree.
\se
\ps vt
\wr B
...
\sn 1
\gn poke
\dn press ‹s.th., s.o.› with finger or longish object (stick+); poke ‹s.th.,
s.o.›
\rf DG1-25
...
\xn Some people may make jokes, as long as they restrain themselves, with respect to
the family who are in mourning.
\nt /li-tobo ñe/ = ils se maîtrisent, restent dans la limite…
\lf
\el
\nt
\nq
...
\rf DG2-12a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (81).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\un Synt.
\en The possessor encoded with the direct (inalienable) pronoun is the person
represented on the photo.
\sn 2
\wn
\hn fig
...
\un Synt.
\en The possessor encoded with the ordinary (alienable) marker |vl{enone} is the
owner of the photo, not its object.
\el Mota
\et totoɣale
\eg picture
\nt
...
\rf q
\xv Le-le ne touro li-odo aero?
\xn Shall we go to the reef shore look for seashells?
\rf DP2-15b+
\xv Dapa li-woi nuduro ne touro.
\xn They put up taboo signs (|vl{nuduro}*) on the reef shore.
\lf Cf.
\lv moko
\el
\nt
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (68).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\rf
\xv Li-bi ua vilo nga pon, nganae nga bale, vewo, iliro, teno… li-kamai.
\xn They went to pick various fruits, such as breadfruit, chestnuts, lychees…, and
they brought them.
\lf
\el POc
\et *puaq
...
\rf DP2-20b
\xv Ua bale we Ginio, pi-pinoe ñei.
...
\xn They had two types of bananas: vl:vaiene, and vl:vakaero.
\se udo we tadoe
\ps n
\gr
\ll Spirits' banana
...
\rf DG2-11a
\nq identif°?  not a banana!
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (106).jpg
\nq =Mtp /na-malsas/
\el POc
\et *pudi
\nt
...
\ge
\gn
\dn unidentified tree variety, similar to Areca catechu (fl:see fv:buioe),
yet unsuitable for human consumption
\sc
\sd Bot
\rf DG2-15b
\lf
...
\rf
\xv Et' aidi li-odo uko ñe basa damiliko iadapa.
\xn The mums are looking for lice on their children's heads.
\se mada uko
\ps n
\gr
\ll ?? of louse
...
\nq how does a woman call her HM?
\sn 2
...
\xn My baby trembles and coughs.
\lf
\el
\nt
\nq
...
\xv Ero i-pu i-abu i-vagasi revo.
\xn The river flows down to [ax:lit. reaches] the sea.
\sn 3
\wn +time
\uv
...
\ge
\gn swiftlet
\dn White-rumped Swiftlet
\sc Aerodramus spodiopygius
\sd Ornith
\rf DG2-16a
\lf
\nt what about /Aerodramus vanikorensis/ ?!
\el
\nt
\nq
\dc 28/Nov/2009
...
\rf DG2-12a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (103).jpg
\nq =Mtp /nōyōvōg/
\el
\nt
\nq
...
\un
\en Contrary to |vl{~mikae}* ‘do what’ and |vl{~kae}* ‘do how’ which both take a
personal subject, |vl{~ve} always takes a (semantically impersonal) 3sg subject
|vl{i-}. The surface form is therefore always |fv{ive} (for |vl{i-ve}).
\sn 1
\wn main predicate
...
\rf
\xv I-ve? Ba-romo kupa wako we tamwaliko?
\xn Now what? Do you like us or not?
\rf xxx
\xv Aia kape i-ka ne! – Ka i-ve?
\xn Your father's coming! – So what?!
\sn 2
\wn in hesitation
\dn what? Used when the speaker looks for his words to describe a
whole event
\rf
...
\dn why?
\rf
\xv Eo a-mokoiu ai-ovili pe i-ve?
...
\xv Lekele i-nge ua vede.
\xn Flying-foxes chew fruits of pandanus.
\nt corresponds to /nēgēy/ in Mwotlap!!  not to /nōyōpdēge/ or /na-gavag/
\lf
\el POc
\et *padran
\nt
...
\sd Bot
\rf DG2-12a
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (84).jpg
\lf
\el
\nt
\nq
...
\ge
\gn pudding
\dn k.o. pudding made of taros (|fv{jebute}) and almonds
(|fv{vongoro}), always presented in a long shape, and served on
long Heliconia leaves (|fv{lukilo vekai}) during public celebrations
\rf Lupo.23
...
\ta §TIT§ |{tab}|fb{Some speech verbs}  [|vl{~vete}*]
|{tab}|fv{~vete}   |{tab}|{tab}|fs{say, mention}
|{tab}|fv{~vete piene}   |{tab}|fs{talk, speak}
|{tab}|fv{~mo}    |{tab}|{tab}|fs{talk, speak}
|{tab}|fv{~atevo}   |{tab}|{tab}|fs{tell s.th.}
|{tab}|fv{~viñi}   |{tab}|{tab}|fs{tell s.o.}
...
\ge
\gn
\dn k.o. plant whose leaves are traditionally used for wrapping food
\sc
\sd Bot
\rf Quest
\lf
...
\gn chestnut
\ge châtaigne
\rn chestnut ; Inocarpus fagifer
\re châtaigne ; Inocarpus fagifer
\dn Polynesian chestnut
\de Châtaignier de Tahiti
\sc Inocarpus fagifer
\sd Bot
\rf DG2-10b
\xv utele vewo pine ponu
...
\on elliptical
\xn You invited them (for a meal): is it because you are rich? [ax:lit. because it
trips you up]
\rf
\un
...
\rf
\xv Buro i-viane dapa ka li-le.
\xn [a song hit them as they went] As they walked, they were suddenly moved by
a (beautiful) song.
\rf
\sn 8
\uv |vl{awa}* ‘neck > will’
...
\lf
\el
\nt exact meaning?  cf. run, disappear, wander, escape...
\dc
\dt 24/May/2012
...
\rf DG2-11b
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (71).jpg
\nq Mtp /nagatqēh/
\el
\nt
\nq
...
\xn This is not Alocasia, this is Colocasia taro.
\lf
\el POc
\et *piRaq
\nt
...
\uv taro
\ll hit edge of pit›
\dn grow large enough to reach the edge of the taro pit (|vl{mwa
tanoe}) in the garden; fl:hence grow big
\rf DG1-46a
\xv
\xn
\el
...
\xn Then we find a rope and fasten tight the canoe's elements.
\nt John N. n'est pas d'accord avec cette phrase, il préfère /le-ngago/.
\rm
\xm Ni-odo tenuro me ne-vo ñe mwoe.
\xb ...
\lf
\sn 2
\ge ériger
\gn erect
\dn put up, erect ‹s.th.›, with or without usage of rope
\rf
\xv Li-vo aero i-dai.
\xn They have erected a fence around it.
\nt d'après John ça n'implique pas corde, mais simplement on fiche en terre...
\lf Syn.
\lv ~vesu
\lv ~woi
\sn 3
...
\xn She taught people how to build houses.
\el
\nt
\nq
\dc 13/Mar/2008
...
\xb fog
\un
\en The phrase |vl{von' i-la} ‘it is dusk’ has been contracted into vl:vonila ‘evening’.
\sn 2
\hn rare
\dn the world, universe
\rf
\xv ne lovia* vono iote
\xn in the Other World
\un
\en Neither vl:vono or |vl{lovia vono} are used as the normal word to designate the
present world.
\nt check
\nt marama ??? <  Mota
\lf Cf.
...
\rf DG2-11a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (98).jpg
\el ax:See PROc
\et *vaRo
\nt
\nq
...
\sd Anat
\rf DG1-35b
\xv I-la puro kula i-vio ne waluko.
\xn He had a few arrows tied around his waist.
\el
\nt
\dc 28/Feb/2010
\dt 28/Feb/2010
...
\ge
\gn
\dn a membranophone drum, not native from Vanikoro, but found in
islands further West
\sd Mus
\rf DG1-45a
\un Etym.
\en The body of the drum is made out of a sago tree, hence the name vl:ote ‘sago tree’.
\lf
\el
\nt
\nq
...
\rm
\xm La-wamu ne bonge iote pon.
\xb They hid in a cave.
\se ~wamu piene
\ps voi
\gr tok-haed
\ll hide speech
\dn talk using cryptic words, in order to keep o.'s speech hard to
understand for the casual hearer
\rf DP1-34a
...
\xn [Go fix this girl for me] Please go and connect me with that girl!
\lf
\el
\nt
\nq
...
\xn that mountain that's lying over there
\rf
...
\hn esp
\uv s.th.
\dn be located somewhere after having be displaced. Usually not
translated
\rf
\xv U-re i-wene!
...
\rm
\xm ebele temaka iadapa i-wene ne basa kulumoe.
\lf
\el POc
\et *qenop
\nt
...
\xn Whatever they wanted, they could have it. [ax:lit. it was there with them]
\rf
\xv Sitoa iote i-wene tev' ai' one.
\xn My father had a shop.
\lf
\el
\nt
\nq
...
\xn Cyrtosperma taros, we dig them out with the digging stick, and take them
home.
\rf cf. DP1-26a
\un Techn
...
\xv I-tau jebute moioe ponu, i-loko i-ka i-le ne monone ka i-wete. I-wete awoiu ka
i-ejau mama ada.
\xn Once the taro was cooked, she put it in a bowl and began to pound it. When
she finished pounding it, she made the pudding.
\rf
\xv Li-wete jebute li-wete vongoro awoiu pon, li-ejau mama.
...
\gr
\ll pound pudding
\dn prepare the |fv{mama}* pudding, by pounding cooked taros and
Canarium almonds in a bowl (fv:monone) with a pestle
\rf
...
\ge porter
\gn carry
\dn carry ‹basket, net+› on o.'s back, hanging from a strap put around
forehead
\rf
\xv Ni-wo topola 'none ne die 'ne.
\xn I'm carrying my basket on my back.
\nq topola = bag? basket??
\un
\en This way of carrying is typically used when coming back home from the gardens,
whether to carry firewood or harvested food.
\lf
\el
\nt
\nq
...
\rf DP1-34b
\xv La-tabo la-wo enga temaka.
\xn Let's list all the place names again.
\lf
\sn 3
\hn hence
\dn read
...
\sn 1
\gn stick
\dn stick ‹long object: knife+› into s.th.; drive in
\rf John Nabu = DP2-20a
\xv Li-woi okoro ñe utedie ini.
\xn They stuck a knife in his back.
\xm Mwaliko iote i-woi okoro ñe utedie ene!
\xb Someone has stabbed a knife on my back.
\xm ?? Mwaliko iote i-woi utedie ene ñe okoro!
\xb ?? Someone has stabbed a knife on my back.
\sn 2
\hn
...
\ge dresser
\gn erect
\dn put up, erect ‹post+› by sticking it on ground
\rf DG1-16a
\rf Lupo.66
...
\rf
\xv li-woi okoro
\xn pound bamboos on the ground, to make music [ax:see |vl{~woi okoro}]
\lf Syn.
\lv ~wete
\ln
\el
...
\lx ~woi okoro
\ph (i·)woi okoro
\pc .G.c:\Alex\photoDico\buro-duo-NB.jpg;2.6";3.9";JPG
\ps voi
\ll stick bamboos
\dn pound heavy bamboos vertically and repeatedly onto the ground,
to mark bass rhythms while singing
\sd Mus
\rf
\xv Kape ba-woi okoro, bai-oburo ne mane.
\xn We shall pound the bamboos and sing songs, in the dancing area.
\nt photo?  explanations?
\un
\en Bamboos are especially played that way in a musical genre called |fv{Buro bula
okoro} ‘Songs for bamboos’. A handful of musicians are lined up in the centre of
the village area (vl:mane); as they pound the bamboos, they sing songs, to the
sound of which the dancers dance around them.
\nt faire encadré!  +  image
\lf
\el
\nt
\nq
...
\rf DG2-12a
\lf
\url C:\Alex\Photos\Selections\2003-Tree-album\Plants-album (95).jpg
\el
\nt
\nq
\dc 28/Feb/2010
...
\lf Cf.
\lv vede
\nt corresponds to /na-gavag/ in Mwotlap!!  not to /nēgēy/ or /nōyōpdēge/
\el
\nt
\nq
\dc 28/Nov/2009
...
\ge puiser
\gn draw_water
\dn draw ‹water, salt water› in bamboo
\rf
\xv Emel' iote i-le i-wowo revo i-ka i-sabisi se awene.
